...
// // Mock verification credential data generator
...
//   const [verificationData] = useState(() => wine ? getVerificationData(wine) : null);

//   if (!isOpen || !wine || !verificationData) return null;
